...
class APIUseWalker extends ASTWalker {
  constructor(repo, file) {
    ...
    this._globals = ['Infinity', 'NaN', 'null', 'Object', 'Function', 'Boolean', 'Symbol', 'Error', 'EvalError', 'RangeError', 'ReferenceError', 'SyntaxError', 'TypeError', 'URIError', 'Number', 'Math', 'Date', 'String', 'RegExp', 'Array', 'Int8Array', 'Uint8Array', 'Uint8ClampedArray', 'Int16Array', 'Uint16Array', 'Int32Array', 'Uint32Array', 'Float32Array', 'Float64Array', 'Map', 'Set', 'WeakMap', 'WeakSet', 'ArrayBuffer', 'DataView', 'JSON', 'Promise', 'Reflect', 'Proxy', 'Intl', 'console', 'exports', 'global', 'module', 'process'];
    ...
    this.add_watcher('VariableDeclarator', variableDeclarator => {
      ...
      if (variableDeclarator.init) {
        ...
        switch (variableDeclarator.init.type) {
          ...
          default:
            return;
            // console.dir(variableDeclarator, {colors:true, depth: null})
            // throw new Error(`Unknown variableDeclarator.init.type: ${variableDeclarator.init.type}`);
        }
